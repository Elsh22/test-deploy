  ...
  const programs = [
    {
      ...
      description: 'Enhance your professional online presence with our LinkedIn workshop.',
    },
    {
      img: SuitDayImg,
      title: 'Suit Day',
      description: 'A day dedicated to professional attire advice and photoshoots.',
    },
    {
      img: ResumeWorkshopImg,
      title: 'Resume Workshop',
      description: 'Join our workshop to create or polish your resume.',
    },
  ];
    ...
    <section className="bg-black text-white py-16 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mt-12">
          <a
            href="https://web.groupme.com/join_group/89916400/H3d6zVwp"
            target="_blank"
