...
export async function POST(req, res) {
    const {firstName, lastName, dob, email, phone, address, city, state, zip,schoolEmail, classification, gradDate, major, gpa,involvementEssay, financialChallengesEssay, goalsEssay,} = await req.json();
  try {
