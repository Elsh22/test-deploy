    ...
    <div className="flex flex-col gap-5 pb-20">
      ...
      <div className="flex gap-7 items-start max-lg:flex-col">
        <div className="h-screen w-1/2 max-lg:w-full flex flex-col gap-5 bg-white rounded-3xl py-5 px-8 mb-20">
          <p className="font-bold text-base">Select or Deselect</p>
        ...
        <div className="w-1/2 max-lg:w-full flex flex-col gap-7">
          {isGroup && (
            <>
              <div className="flex flex-col gap-3">
                <p className="font-bold text-base">Group Chat Name</p>
                <input
              ...
              <div className="flex flex-col gap-3">
                <p className="font-bold text-base">Members</p>
                <div className="flex flex-wrap gap-3">
                  {selectedContacts.map((contact, index) => (
                    <p className="text-sm font-bold p-2 bg-pink-500 rounded-lg" key={index}>
                      {contact.username}
                    </p>
                  ))}
                </div>
          ...
          <button
            className="flex items-center justify-center rounded-xl p-3 bg-gradient-to-l from-blue-500 to-blue-700 text-white font-bold cursor-pointer hover:bg-opacity-90"
            onClick={createChat}
